...
export default async function Page({
  ...
  const IntroduceVideos: VideoIntroduceItemProps[] = [
    {
      ...
      videoSrc:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/H.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/G.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/B.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/K.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/J.png",
    },
    {
      ...
      videoSrc:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/D.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/L.png",
    },
  ];

  const videoEffectStyleStepArr = [
    {
      id: 1,
      img: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/C.png",
    ...
    {
      id: 2,
      img: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/D.png",
      paragraph:
    ...
    {
      id: 3,
      img: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/E.png",
      paragraph:
  ...
  const ExploreVideos = [
    {
      id: 1,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/I.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/H.png",
    },
    {
      id: 2,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/C.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/A.jpg",
    },
    {
      id: 3,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/E.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/M.png",
    },
    {
      id: 4,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/J.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/I.png",
    },
    {
      id: 5,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/F.mp4",
      poster:
        "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/F.png",
    },
    {
      id: 6,
      src: "https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/L.mp4",
      poster: "",
    },
  ];
  ...
  return (
    <div className="w-full h-full relative">
      ...
      <section className="w-full h-full">
        <div className="relative overflow-hidden aspect-[16/9] md:aspect-[21/9] mx-2 sm:mx-4 lg:mx-5 my-2 sm:my-4 lg:my-5 rounded-lg sm:rounded-xl lg:rounded-2xl">
          ...
          <video
            ...
            autoPlay
            muted
            poster="https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/poster/N.png"
            loop
            playsInline
          >
            <source
              src="https://pub-d971bff5576c4337bba795092aa63092.r2.dev/VideoEffects/kiss/viedo/A.mp4"
              type="video/mp4"
            />
          </video>
          {/* 内容层 */}
            ...
            <div className="text-left w-full max-w-[280px] sm:max-w-lg lg:max-w-2xl">
              <hgroup className="mb-3 sm:mb-6">
                <h1 className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-5xl font-bold leading-tight mb-1 sm:mb-3 lg:mb-4">
                  <span className="block sm:inline">AI Kiss</span>
                </h1>
                <p className="text-white text-xs lg:text-lg font-normal mb-3 sm:mb-5 lg:mb-6">
                  Discover amazing wildlife moments captured on camera. Explore
                  fascinating animal behaviors and rare wildlife encounters from
                  around the world.
                </p>
              </hgroup>
      ...
      <section className="pt-20">
        {IntroduceVideos.map((item: VideoIntroduceItemProps, index: number) => (
          <VideoIntroduceItem
            key={index}
            title={item.title}
      ...
      <section className="bg-[url('/ai-video-generator/a.svg')] bg-no-repeat bg-cover overflow-hidden w-full pt-20 ">
        <div className="max-w-7xl mx-auto w-full px-4">
          <h2 className="text-center text-3xl md:text-4xl font-bold mb-10">
            How to Generate AI Video
          </h2>
          <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4">
            {videoEffectStyleStepArr.map((item, index) => (
...
function VideoIntroduceItem({
  ...
  return (
    <div
      className={cn(
        "max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-16 justify-between items-center w-full mb-16 lg:mb-20 px-4",
        isEven ? "lg:flex-row" : "lg:flex-row-reverse"
      )}
    >
      <div className="w-full lg:w-1/2 flex justify-center lg:justify-start">
        <div className="w-full max-w-md md:max-w-lg lg:max-w-full">
          <div className="overflow-hidden rounded-lg mb-4 max-h-[300px]">
            <video
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        ...
        <LinkButton
          GTMName={`ai-kiss-introduce-${index}`}
          path="/video-effects/ai-kiss"
          name="Get Started"
        />
      </div>
