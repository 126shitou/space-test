...
export default async function Page({
  ...
  const ImageIntroduces: ImageIntroduceItemProps[] = [
    {
      title: "Introducing ImagineArt Anime Generator Tool",
      width: 692,
      height: 527,
      paragraph:
      ...
      imageSrc:
        "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-introduce-1_na7lxg.png",
    },
    {
      title: "Create Personalized Anime Characters",
      width: 718,
      height: 535,
      paragraph:
        "Generate AI images with the face and content from your input images to get more satisfying results when using AI Ease’s online image-to-image AI generator. Our tool can learn, imitate, and output similar AI photos by adjusting the intensity of the reference strength. The higher the intensity is, the more similar the results will be when creating consistent visuals in our AI picture generator.",
      imageSrc:
        "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-introduce-2_izpheg.png",
    },
    {
      title: "From Chibi to Ghibli - Our AI Anime Generator Has it All!",
      width: 814,
      height: 399,
      paragraph:
        "Our AI Image Generator is the solution to all your creative needs!Whether you love traditional anime or modern interpretations,explore a variety of styles that will give your photos an entirely new look, from cute Chibi to nostalgic Ghibli, the world is your oyster.",
      imageSrc:
        "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-introduce-3_k8wmqm.png",
    },
    {
      title: "An AI Anime Generator that Listens",
      width: 718,
      height: 409,
      paragraph:
        "Imagine strictly follows your input prompts, creating AI anime art that matches your description and style preferences, with no surprises.",
      imageSrc:
        "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-introduce-4_q3929o.png",
    },
  ];

  const AICartoonStepArr = [
    {
      id: 1,
      img: "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-howtodo-1_px0jsg.png",
      paragraph:
        "Write your text prompts for AI image generations in our text box.The more detailed your prompts are,the more delicate the output will be.",
      title: "Step 1: Enter Text Prompts",
    },
    {
      id: 2,
      img: "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-howtodo-2_agscfj.png",
      paragraph:
        "Pick your preferred AI generation style in our style library, and then choose the number and aspect ratio of AI generated images.",
      title: "Step 2: Choose Styles and Settings",
    },
    {
      id: 3,
      img: "https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-howtodo-3_prlcbq.png",
      paragraph:
        "Once ready, click the “Generate” button, and our tool will output your AI images in seconds. Download and share it when satisfied.",
  ...
  return (
    <div className="w-full h-full relative">
      ...
      />
      <section className="relative w-full bg-[url('/ai-image-cartoon-generator/a.svg')] bg-no-repeat bg-cover overflow-hidden pb-10">
          ...
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-8 justify-center items-center mb-10 lg:mb-20">
            <div className="text-center lg:text-left lg:flex-1">
              ...
              <div className="hidden lg:block">
                <LinkButton
                  GTMName="ai-cartoon-generator-starter"
            ...
            <div className="lg:flex-1 flex justify-center">
              <div className="w-full min-w-[300px] max-w-sm md:max-w-lg lg:max-w-full aspect-[823/627] relative">
                <Image
                  src="https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-hero_gy0rle.png"
                ...
                />
                <Image
                  src="https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-hero-1_dztmgi.png"
                  alt="Free AI Image Generator - Create stunning AI-generated artwork from text prompts with AI Ease"
                  width={150}
                  height={112}
                  className="object-cover absolute z-[9] -left-20 bottom-10 scale-75 sm:scale-90 lg:scale-150"
                  priority
                />
                <Image
                  src="https://res.cloudinary.com/dsciihnpa/image/upload/ai-cartoon-hero-2_hrwiqr.png"
                  alt="Free AI Image Generator - Create stunning AI-generated artwork from text prompts with AI Ease"
                  width={120}
                  height={90}
                  className="object-cover absolute z-[9] -right-16 top-1/2 transform -translate-y-1/2 scale-75 sm:scale-90 lg:scale-150"
                  priority
                />
              </div>
            </div>
            <div className="block lg:hidden w-full">
              <LinkButton
                GTMName="ai-cartoon-generator-starter-mobile"
                path="/tool/ai-cartoon-generator"
                name="Get Started"
              />
            </div>
      ...
      <section className="bg-[url('/ai-image-cartoon-generator/a.svg')] bg-no-repeat bg-cover overflow-hidden w-full pt-20 pb-20">
        <div className="max-w-7xl mx-auto w-full px-4">
          <h2 className="text-center text-3xl md:text-4xl font-bold mb-10">
            How to Generate AI Images
          </h2>
          <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4">
            {AICartoonStepArr.map((item, index) => (
          ...
          <div className="flex justify-center mb-10">
            <LinkButton
              GTMName="ai-cartoon-generator-howTo"
              path="/tool/ai-cartoon-generator"
              name="Get Started"
            />
          </div>
