...
export default async function Page({
  ...
  const IntroduceVideos: VideoIntroduceItemProps[] = [
    {
      ...
      videoSrc:
        "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-introduce-1.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-introduce-2.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-introduce-3.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-introduce-4.mp4",
      poster:
    ...
    },
    {
      ...
      videoSrc:
        "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-introduce-5.mp4",
      poster:
  ...
  const ExploreVideos = [
    {
      id: 1,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-1.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-1.png",
    },
    {
      id: 2,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-2.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-2.png",
    },
    {
      id: 3,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-3.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-3.png",
    },
    {
      id: 4,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-4.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-4.png",
    },
    {
      id: 5,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-5.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-5.png",
    },
    {
      id: 6,
      src: "https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-explore-6.mp4",
      poster:
        "https://res.cloudinary.com/dsciihnpa/image/upload/f_auto%2Cc_limit/ai-video-effects-thumb-6.png",
    },
  ];
    ...
    <div className="w-full h-full relative">
      ...
      <section className="w-full h-full">
        <div className="relative overflow-hidden  aspect-[16/9] md:aspect-[21/9]  mx-2 sm:mx-4 lg:mx-5 my-2 sm:my-4 lg:my-5 rounded-lg sm:rounded-xl lg:rounded-2xl">
          ...
          >
            <source
              src="https://res.cloudinary.com/dsciihnpa/video/upload/f_auto%2Cc_limit/animals-caught-on-camera-banner.mp4"
              type="video/mp4"
            />
          </video>
          {/* 内容层 */}
            ...
            <div className="text-left w-full max-w-[280px] sm:max-w-lg lg:max-w-2xl">
              <hgroup className="mb-3 sm:mb-6">
                <h1 className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-5xl font-bold leading-tight mb-1 sm:mb-3 lg:mb-4">
                  <span className="block sm:inline">Animals Caught</span>
                  <br className="hidden sm:block" />
                  <span className="block sm:inline">on Camera</span>
                </h1>
              ...
              <div className="w-full flex justify-start">
                <LinkButton
                  GTMName="animals-caught-on-camera-starter"
                  path="/video-effects/animals-caught-on-camera"
                  isHero
                  name="Get Started"
                />
              </div>
